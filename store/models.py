...
class ProductSpecificationValue(models.Model):
    """
    The Product Specification Value table holds each of the prooducts individual specification or bespoke features.
    """
...
class ProductImage(models.Model):
    ...
    alt_text = models.CharField(verbose_name=_("Alturnative text"), max_length=255, help_text=_("Please add alturnative text"))
