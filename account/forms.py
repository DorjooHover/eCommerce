...
class UserEditForm(forms.ModelForm):
    ...
    user_name = forms.CharField(label='Username', max_length=50, min_length=4, widget=forms.TextInput(attrs={'class': 'form-control mb-3', 'placeholder': 'Username', 'id': 'form-username', 'readonly': 'readonly'}))

    first_name = forms.CharField(label='Firstname', max_length=50, min_length=4, widget=forms.TextInput(attrs={'class': 'form-control mb-3', 'placeholder': 'Firstname', 'id': 'form-firstname', 'readonly': 'readonly'}))
...
class PwdResetConfirmForm(SetPasswordForm):
    ...
    new_password2 = forms.CharField(label='Repeat password', widget=forms.PasswordInput(attrs={'class': 'form-control mb-3', 'placeholder': 'New Password', 'id': 'form-newpass2'}))
